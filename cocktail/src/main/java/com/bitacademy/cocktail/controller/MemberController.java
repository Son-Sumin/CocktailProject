...
public class MemberController {
	...
	public Token Login(@RequestBody Map<String, String> user) {
		...
		System.out.println(
				"~~~~~~~~~" + jwtTokenProvider.createToken(member.getId(), member.getRole(), member.getNickname()));
//		return jwtTokenProvider.createToken(member.getId(), member.getRole(), member.getNickname());
		return Token.builder()
				.token(jwtTokenProvider.createToken(member.getId(), member.getRole(), member.getNickname())).build();
	}
